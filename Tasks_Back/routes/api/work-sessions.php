...
//   Admin endpoints: the "admin" role always passes; other roles need the
//   permissions from WorkSessionPermissionSeeder (role_or_permission middleware).
//
...
Route::middleware(['auth:sanctum'])->prefix('work-sessions')->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        Route::middleware('role_or_permission:admin|view all work sessions')->group(function () {
        ...
        Route::middleware('role_or_permission:admin|manage work sessions')->group(function () {
            Route::post('/sessions/{workSession}/reopen', [WorkSessionAdminController::class, 'reopen'])
                ->whereNumber('workSession');
        });

        Route::middleware('role_or_permission:admin|view work session reports')->group(function () {
        ...
        Route::middleware('role_or_permission:admin|export work session reports')->group(function () {
            Route::post('/reports/export-pdf', [WorkSessionReportController::class, 'exportPdf']);
        });

        Route::middleware('role_or_permission:admin|rate work sessions')->group(function () {
