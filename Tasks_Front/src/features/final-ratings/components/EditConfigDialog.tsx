...
import { ScrollArea, ScrollBar } from '@/components/ui/scroll-area'; // 👈 add
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[95vw] max-w-3xl max-h-[90vh] p-0 overflow-hidden">
        ...
        {/* Scrollable body (vertical + horizontal if needed) */}
        <ScrollArea className="max-h-[calc(90vh-160px)]">
          {/* ~160px = header + footer; tweak if your spacing differs */}
          <form onSubmit={handleSubmit} className="space-y-6 px-6 py-6">
            ...
            {/* Sticky footer inside the scroller */}
