...
const TaskRatingsPage: React.FC = () => {
  ...
  useEffect(() => {
    if (activeConfigs?.length) setSelectedConfigId((prev) => prev ?? activeConfigs[0].id)
      ...
      <div className="flex-1 space-y-6 p-4 md:p-6 max-w-full">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground font-sans">Task Ratings</h1>
          ...
          <div className="space-y-4">
            <Card className="bg-card border-border">
              <CardContent className="p-4">
                <div className="flex items-center justify-between gap-4">
                  <div className="min-w-0">
                    ...
                    <p className="text-base font-medium truncate">
                      {activeConfig ? activeConfig.name : isConfigsLoading ? 'Loading…' : '—'}
                    </p>
                  </div>
                  <div className="w-64">
                    <Select
                ...
                {configsError && (
                  <p className="mt-2 text-sm text-destructive">{String(configsError)}</p>
                )}
              </CardContent>
            </Card>
